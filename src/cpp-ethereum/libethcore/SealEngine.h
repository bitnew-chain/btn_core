...
////////////////////////////////////////////////////////////// // btn
	void setBtnSchedule(EVMSchedule _btnSchedule) const { btnSchedule = _btnSchedule; }

	EVMSchedule& getBtnSchedule() const { return btnSchedule; }
...
private:
	...
	mutable EVMSchedule btnSchedule; // btn
