...
#include "genesis/btnMainNetwork.cpp"
#include "genesis/btnTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::btnMainNetwork: return c_genesisInfoBtnMainNetwork;
	case Network::btnTestNetwork: return c_genesisInfoBtnTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::btnMainNetwork: return c_genesisStateRootBtnMainNetwork;
	case Network::btnTestNetwork: return c_genesisStateRootBtnTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
