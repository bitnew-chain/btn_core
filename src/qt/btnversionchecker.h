#ifndef BTNVERSIONCHECKER_H
#define BTNVERSIONCHECKER_H

#include <QObject>

#define BTN_RELEASES "https://github.com/btnproject/btn/releases"
...
class BtnVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit BtnVersionChecker(QObject *parent = 0);
    ~BtnVersionChecker();
