...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
                 tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR BTNS</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
            ...
            if(newpass1 == newpass2)
            {
                if(model->setWalletEncrypted(true, newpass1))
                {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                                         ...
                                         "your BTNs from being stolen by malware infecting your computer.").arg(tr(PACKAGE_NAME)) +
                                         "<br><br><b>" +
    ...
    case Decrypt:
        if(!model->setWalletEncrypted(false, oldpass))
        {
            ...
            //                      tr("The passphrase entered for the wallet decryption was incorrect."));
	    QMessageBox btnRetVal(QMessageBox::Critical, tr("Wallet decryption failed"),
			    tr("The passphrase entered for the wallet decryption was incorrect."));
	    btnRetVal.setButtonText(QMessageBox::Ok, tr("Ok"));
	    btnRetVal.exec();
        }
    ...
    case ChangePass:
        if(newpass1 == newpass2)
        {
	    	...
	    	QMessageBox btnRetVal(QMessageBox::Information, tr("Wallet encrypted"),
                                     tr("Wallet passphrase was successfully changed."));
	    	btnRetVal.setButtonText(QMessageBox::Ok, tr("Ok"));
	    	btnRetVal.exec();
                QDialog::accept(); // Success
        ...
        else
        {
            //QMessageBox::critical(this, tr("Wallet encryption failed"),
            //                     tr("The supplied passphrases do not match."));
	    QMessageBox btnRetVal(QMessageBox::Information, tr("Wallet encryption failed"),
                                 tr("The supplied passphrases do not match."));
	    btnRetVal.setButtonText(QMessageBox::Ok, tr("Ok"));
	    btnRetVal.exec();
        }
