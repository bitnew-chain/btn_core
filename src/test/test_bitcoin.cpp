...
////////////////////////////////////////////////////////////// btn
        ...
        globalState = std::unique_ptr<BtnState>(new BtnState(dev::u256(0), BtnState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::btnTestNetwork)));
