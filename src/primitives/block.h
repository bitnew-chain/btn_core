...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // btn
        hashUTXORoot.SetNull(); // btn
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //btn
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //btn
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //btn
    {
