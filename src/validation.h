...
/////////////////////////////////////////// btn
#include <btn/btnstate.h>
#include <btn/btnDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <btn/storageresults.h>
...
using ExtractBtnTX = std::pair<std::vector<BtnTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
static const size_t MAX_CONTRACT_VOUTS = 1000; // btn
...
void EnforceContractVoutLimit(ByteCodeExecResult& bcer, ByteCodeExecResult& bcerOut, const dev::h256& oldHashBtnRoot,
    const dev::h256& oldHashStateRoot, const std::vector<BtnTransaction>& transactions);
...
class BtnTxConverter{

public:

    BtnTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransactionRef>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionBtnTransactions(ExtractBtnTX& btnTx);
...
private:
    ...
    BtnTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<BtnTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
